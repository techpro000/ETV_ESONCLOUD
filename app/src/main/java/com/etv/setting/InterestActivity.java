...
public class InterestActivity extends BaseActivity implements View.OnClickListener {
    ...
    /***
     * 每分钟去检测屏幕状态，如果是亮屏状态，直接关闭界面
     */
    private void checkBackLightStatues() {
//        MyLog.phone("====休眠界面接受到广播。去播放界面");
//        if (AppConfig.APP_TYPE != AppConfig.APP_TYPE_HUANGZUNNIANHUA_ONE_LEY_POLICE) {
//            return;
//        }
//        boolean isBackLightStaues = SystemManagerInstance.getInstance(InterestActivity.this).getBackLightTtatues("息屏界面定制获取状态");
//        if (isBackLightStaues) {
//            startToMainView();
//        }
    }
