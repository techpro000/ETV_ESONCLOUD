...
public class PlayerTaskActivity extends TaskActivity implements PlayTaskView {
    ...
    private BroadcastReceiver receiverPlayTask = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(AppInfo.DOWN_TASK_SUCCESS)) {
                ...
                checkBackLightStatues("Intent.ACTION_TIME_TICK");
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        mBingding.btTest.setOnClickListener(v -> {
            long aaa = System.currentTimeMillis();
            ScreenUtil.screenShot(getApplication(), "/sdcard/test.jpg");
            long end = System.currentTimeMillis();
            System.out.println("update====================> " + (end - aaa));
        });
        mBingding.btTest.setVisibility(View.GONE);
    }
    ...
    protected void onResume() {
        super.onResume();
        checkBackLightStatues("PlayTaskActivty onResume");
...
//            }
    ...
    private boolean lineHdmInAidl() {
        ...
        System.out.println("aaaaaaaaaaaa update----hdmi---> " + isApkInstall);
        if (!isApkInstall) {
