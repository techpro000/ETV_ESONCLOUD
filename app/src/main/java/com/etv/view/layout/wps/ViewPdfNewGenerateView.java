...
public class ViewPdfNewGenerateView extends Generator {
    ...
    MediAddEntity mediAddEntity = null;
    View view;
    /**
     * 间隔时间
     */
    ...
    public ViewPdfNewGenerateView(Context context, CpListEntity cpListEntity, int x, int y, int width, int height, MediAddEntity mediAddEntity) {
