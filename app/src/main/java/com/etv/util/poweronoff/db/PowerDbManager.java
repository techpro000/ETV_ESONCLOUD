...
//        默认的定时开关机时间23:30---05:30
//        if (AppConfig.APP_TYPE == AppConfig.APP_TYPE_POWERONOFF /*&& workModel == AppInfo.WORK_MODEL_SINGLE*/) {
//            TimerDbEntity timerDbEntity = new TimerDbEntity("9527", "5:30", "23:30", "true", "true", "true", "true", "true", "true", "true");
//            lists.add(timerDbEntity);
//        }
    ...
    public static boolean modifyTimeById(TimerDbEntity timeDbEntity) {
        ...
        try {
            ...
            int updateNum = LitePal.updateAll(TimerDbEntity.class, values, timerId);
            if (updateNum > 0) {
                isModify = true;
            }
        } catch (Exception e) {
