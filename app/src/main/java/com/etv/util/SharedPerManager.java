...
public class SharedPerManager {
    ...
    public static int getSocketType() {
        int defaultSockeType = AppConfig.SOCKEY_TYPE_WEBSOCKET;
        if (AppConfig.APP_TYPE == AppConfig.APP_TYPE_DEFAULT || AppConfig.APP_TYPE == AppConfig.APP_TYPE_POWERONOFF) {
    ...
    public static boolean getVideoMoreSize() {
        ...
        if (AppConfig.APP_TYPE == AppConfig.APP_TYPE_SHANXI) {
    ...
    public static int getDoubleScreenMath() {
        int defaultMath = AppInfo.DOUBLE_SCREEN_SHOW_PX30;
        if (AppConfig.SHOW_DOUBLE_SCREEN_TYPE == AppConfig.SHOW_DEFAULT_SIZE) {
            return AppInfo.DOUBLE_SCREEN_SHOW_DEFAULT;
        } else if (AppConfig.SHOW_DOUBLE_SCREEN_TYPE == AppConfig.SHOW_MATCH_SIZE) {
            return AppInfo.DOUBLE_SCREEN_SHOW_ADAPTER;
        }
    ...
    public static String getExitpassword() {
        ...
        Log.e("TAG", "getExitpassword: "+exitpassword );
    ...
    public static int getLimitSpeed() {
        ...
        if (ipAddress.contains(ApiInfo.IP_DEFAULT_URL_WEBSOCKET) || ipAddress.contains(ApiInfo.IP_DEFAULT_URL_SOCKET)) {
            limitspeed = 1500;
        }
        return limitspeed;
    }
    ...
    public static int geWPSSingleShowTYpe() {
        int backCode = 0;
        backCode = (int) EtvApplication.getInstance().getData("wpsSingleShowTYpe", BannerConfig.SCREEN_SHOW_TYPE_PROPROTIONAL);
        return backCode;
    }
    ...
    public static String getResourDownPath() {
        String resourceServer = (String) EtvApplication.getInstance().getData("resourceServer", "");
